...
static int lcd_init(void)
{
    ...
    //默认值，此宏为0，表示支持大多数LCD
	s3c_lcd->fix.visual   = FB_VISUAL_TRUECOLOR; /* TFT 真彩色屏*/
    ...
    //xoffset/yoffset表示虚拟和实际分辨率的偏差值，此处不用定义
...
lcd_regs->lcdcon4 =	S3C2410_LCDCON4_MVAL(13) | \
    ...
    lcd_regs->lcdcon5 &= (~(1<<5)); /* 设置LCD_PWREN的极性: 正常/反转 */
    lcd_regs->lcdcon5 |= (0<<5);
